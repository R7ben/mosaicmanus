...
export default function CreateQuizPage() {
  ...
  if (workspace.isLoading || !workspace.data) return <div className="app-loading"><img src="/logo.png" alt="Mosaic Classroom" className="mosaic-mark" /><p>Opening quiz creator…</p></div>;
