...
// How long a session cookie/JWT stays valid. Kept short relative to
// ONE_YEAR_MS so a leaked token has a bounded lifetime; sessionVersion
// (see server/db.ts bumpSessionVersion) covers revoking one before that.
